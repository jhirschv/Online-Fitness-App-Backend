...
ProgramCreateView, ActiveProgramView, SetActiveProgramView, StartWorkoutSessionView, WorkoutSessionDetailView,
 ...
 ClientExercise1RMView, GuestUserCreateAPIView, ClientExercisesWithWeightsView, ClientCumulativeWeightView, ProfilePictureUploadView, RemoveClientView, 
 RemoveTrainerView, ExerciseLogCreationAPI)

router = DefaultRouter()
router.register(r'programs', ProgramViewSet)
router.register(r'user_programs', UserProgramViewSet, basename='user_program')
router.register(r'workouts', WorkoutViewSet)
router.register(r'user_workouts', UserWorkoutViewSet, basename='userworkoutviewset')
...
urlpatterns = [
    ...
    path('remove-client/<int:client_id>/', RemoveClientView.as_view(), name='remove-client'),
    path('remove-trainer/<int:trainer_id>/', RemoveTrainerView.as_view(), name='remove-trainer'),
